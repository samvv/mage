/**
 * The algorithm was directly traken from the paper 'Fast brief
 * practical DFA minimization algorithm' by Antti Valmari. 
 *
 * The following changes were made to the original code:
 * - Applied clang-format to the entire file
 * - Fixed some missing newlines and indentation issues
 *
 * https://www.sciencedirect.com/science/article/pii/S0020019011003267
 * https://www.cs.cmu.edu/~sutner/CDM/resources/Valmari12.pdf
 */
...
partition B, // blocks (consist of states)
